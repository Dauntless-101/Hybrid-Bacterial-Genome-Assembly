...
LABEL description="Lightweight Snakemake image for Hybrid-Bacterial-Genome-Assembly"
LABEL version="1.0.0"
...
ENV PATH /opt/conda/envs/hybrid-assembly/bin:$PATH

# Copy only the files needed for execution
